...
export default function NoteEditor({ initialContent, onChange }: Props) {
  ...
  return (
    <div className='overflow-hidden rounded-md border border-gray-300 dark:border-gray-700'>
      ...
      <div className='min-h-48 bg-white px-4 py-3 text-gray-900 dark:bg-gray-950 dark:text-white [&_.tiptap]:outline-none [&_.tiptap_h1]:mb-2 [&_.tiptap_h1]:mt-4 [&_.tiptap_h1]:text-2xl [&_.tiptap_h1]:font-bold [&_.tiptap_h2]:mb-1 [&_.tiptap_h2]:mt-3 [&_.tiptap_h2]:text-xl [&_.tiptap_h2]:font-bold [&_.tiptap_h3]:mb-1 [&_.tiptap_h3]:mt-3 [&_.tiptap_h3]:text-lg [&_.tiptap_h3]:font-semibold [&_.tiptap_p]:my-1 [&_.tiptap_ul]:my-2 [&_.tiptap_ul]:list-disc [&_.tiptap_ul]:pl-6 [&_.tiptap_code]:rounded [&_.tiptap_code]:bg-gray-100 [&_.tiptap_code]:px-1 [&_.tiptap_code]:font-mono [&_.tiptap_code]:text-sm [&_.tiptap_code]:text-gray-900 [&_.tiptap_code]:dark:bg-gray-800 [&_.tiptap_code]:dark:text-gray-100 [&_.tiptap_pre]:my-2 [&_.tiptap_pre]:rounded [&_.tiptap_pre]:bg-gray-100 [&_.tiptap_pre]:p-3 [&_.tiptap_pre]:dark:bg-gray-800 [&_.tiptap_pre_code]:bg-transparent [&_.tiptap_pre_code]:p-0 [&_.tiptap_pre_code]:text-gray-900 [&_.tiptap_pre_code]:dark:text-gray-100 [&_.tiptap_hr]:my-4 [&_.tiptap_hr]:border-gray-300'>
